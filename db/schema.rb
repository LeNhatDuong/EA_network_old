...
ActiveRecord::Schema[7.0].define(version: 2015_01_19_085417) do
  ...
  create_table "manual_update_logs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "client_ip"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
